package com.akun.data.sources.constants;
...
public class PropertiesConstants {
    ...
    public static final String DEFAULT_KAFKA_BROKERS = "47.98.182.82:9092";
    public static final String KAFKA_ZOOKEEPER_CONNECT = "kafka.zookeeper.connect";
    public static final String DEFAULT_KAFKA_ZOOKEEPER_CONNECT = "47.98.182.82:2181";
    public static final String KAFKA_GROUP_ID = "kafka.group.id";
    public static final String DEFAULT_KAFKA_GROUP_ID = "akun";
